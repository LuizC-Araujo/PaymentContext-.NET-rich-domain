...
{
    public Payment(DateTime paidDate, DateTime expireDate, decimal total, decimal totalPaid, string payer,
        Document document, Address address, Email email)
    {
        ...
        AddNotifications(new Contract<Payment>()
            ...
            .IsGreaterOrEqualsThan(TotalPaid, Total, "Payment.Total", "O valor pago é menor que o valor do pagamento")
        ); 
    }
