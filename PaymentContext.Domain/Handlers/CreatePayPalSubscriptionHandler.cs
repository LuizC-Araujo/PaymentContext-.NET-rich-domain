...
public class CreatePayPalSubscriptionHandler : SubscriptionHandler, IHandler<CreatePayPalSubscriptionCommand>
{
    public CreatePayPalSubscriptionHandler(IStudentRepository repository, IEmailService emailService) : base(repository, emailService)
    {
    }
    ...
    public ICommandResult Handle(CreatePayPalSubscriptionCommand command)
    {
        ...
        var payment = new PayPalPayment(command.PaidDate, command.ExpireDate, command.Total, command.TotalPaid,
